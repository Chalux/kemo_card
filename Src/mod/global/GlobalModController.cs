...
public sealed class GlobalModController : FeatureControllerBase<GlobalModModel>
{
	private readonly GlobalSaveService _saveService;
	private readonly IUiManager _uiManager;

	public GlobalModController(GlobalModModel model, GlobalSaveService saveService, IUiManager uiManager)
		: base(model)
	{
	...
	public void LoadFromDisk()
	{
		...
		InternalBus.Publish(new GlobalSaveChangedEvent(Model.Current));
	}
