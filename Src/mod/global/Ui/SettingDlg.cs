...
public partial class SettingDlg : BaseDlg
{
    ...
    private void OnDisplayConfirmOk(int epoch)
    {
        ...
        gc.SetSetting(DisplaySettingKeys.WindowMode, _confirmedWindowMode);
        gc.SetSetting(DisplaySettingKeys.Resolution, _confirmedResolution);
        gc.SaveToDisk();
    }
    ...
    private void PersistNonConfirmSettings()
    {
        ...
        gc.SetSetting(AudioSettingKeys.MasterVolume, _pendingMasterVolume.ToString());
        gc.SetSetting(AudioSettingKeys.SoundVolume, _pendingMusicVolume.ToString());
        gc.SetSetting(AudioSettingKeys.SfxVolume, _pendingSfxVolume.ToString());
        gc.SetSetting(AudioSettingKeys.MuteFlag, _pendingMuteFlag.ToString());
        gc.SetSetting(LocaleSettingKeys.Language, _pendingLanguage);
        gc.SaveToDisk();
    }
