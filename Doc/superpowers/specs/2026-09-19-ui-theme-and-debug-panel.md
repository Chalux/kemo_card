...
**日期**：2026-09-19
**状态**：已实装
**关系**：服从 [2026-05-11 总规格](2026-05-11-kemo-card-design.md) 与 [2026-05-15 UI 管理器规格](2026-05-15-ui-manager-design.md)；调色板与按钮基类约束全部 Run 内界面。
...
- 该变更与连携系统（[buff 运行时规格 §3](2026-09-19-buff-potential-chain-system-design.md)）同批落地。
