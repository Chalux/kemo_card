...
| [2026-05-17-content-mod-manager-design.md](superpowers/specs/2026-05-17-content-mod-manager-design.md) | 内容 Mod 管道 |
...
当前无进行中计划。新计划放此目录；完成后 `git mv` 至归档并在原路径留 stub。
